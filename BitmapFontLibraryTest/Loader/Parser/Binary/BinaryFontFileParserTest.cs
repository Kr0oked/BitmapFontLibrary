...
namespace BitmapFontLibraryTest.Loader.Parser.Binary
{
    [TestFixture]
    public class BinaryFontFileParserTest
    {
        private BinaryFontFileParser _parser;
        ...
        public void Initialize()
        {
            ...
            _parser = new BinaryFontFileParser(_intAdapter.Object, _fontTextureLoader.Object);
        ...
        public void TestParse()
        {
            ...
            _fontTextureLoader
                .Setup(loader => loader.Load(Path.Combine(_assemblyDirectory, @"Data\Font\binaryTestFont_0.png"), true))
